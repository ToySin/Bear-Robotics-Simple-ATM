...
- First, copy and run the following command to clone this repository on your local machine
```
  git clone https://github.com/ToySin/Bear-Robotics-Simple-ATM.git && cd Bear-Robotics-Simple-ATM
```  
---
- Second, run 'test.sh' file to test the project and generate test result file.
```
  ./test.sh
```  
---
- Then, you can see following text. Copy and paste the path to your browser
```
  vvvvvvvvvv Copy and paste the following path to your browser vvvvvvvvvv
  
  (Your machine's home dir)/Bear-Robotics-Simple-ATM/build/reports/tests/test/index.html
  
  ^^^^^^^^^^ Copy and paste the above path to your browser ^^^^^^^^^^
```
<img width="1532" alt="image" src="https://github.com/ToySin/Bear-Robotics-Simple-ATM/assets/40738437/6d467972-a95f-45d5-9140-4f4192e8f2bc">
